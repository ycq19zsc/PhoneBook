...
using Abp.Hangfire;
using Abp.Owin;
using ZSC.PhoneBook.Api.Controllers;
using ZSC.PhoneBook.Web;
using Hangfire;
...
namespace ZSC.PhoneBook.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in PhoneBookWebModule)
